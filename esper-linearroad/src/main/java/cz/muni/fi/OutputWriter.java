...
public class OutputWriter {
    ...
    private static org.apache.log4j.Logger log = Logger.getLogger(OutputWriter.class);
    ...
    public OutputWriter(DataDriver dataDriver) {
        try {
    ...
    // TODO this can be called concurrently (from dailyExpenditureProcessor), add synchro
